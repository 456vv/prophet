...
//setDefineProperty(window, browser_window);
...
//setDefineProperty(window.screen, browser_screen);
...
//setDefineProperty(window.history, browser_history);
...
//setDefineProperty(window.navigator, browser_navigator);
...
//setDefineProperty(window.location, browser_location);
...
//setDefineProperty(window.localStorage, browser_localStorage);
...
//setDefineProperty(window.document, browser_document);
